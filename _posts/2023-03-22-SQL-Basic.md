...
![Structures of the tables used as examples](/images/post/tables_relation.png)
...
1. Commonly used functions related to string processing:
...
2. Commonly used functions related to numerical processing: 
...
# 8 Aggregate
**Examples**
1. Commonly used SQL aggregate functions:
